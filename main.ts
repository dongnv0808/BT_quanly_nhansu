...
let employee5 = new Employee("Le Thi", "Thuy", new Date("09-19-1996"), "HN", "Quan ly");
...
EmployeeManager.add(employee1, employee2, employee3, employee4, employee5);
...
EmployeeManager.getEmployeeDetail("Thuy")